#!/bin/urs/python
# kalo mau pake izin
# nih no wa : 08992176733
# pemilik KZ.tutorial
# SUBSCRIBE LAH KALO GAK SUBSCRIBE MALAS GUA BIKIN VIDIO SOURCD CODE GRATIS
...
mengetik ("\033[32;1m'Subscribe duluh yt gua Cuy ^-^\033[32;1m'")
mengetik ("\033[32;1m'Kalo gak Subscribe Malas gua kasi sourcdcode gratis ^-^\033[32;1m'")
time.sleep(4)
os.system("clear")
...
{hi}═════════════════════════════════════════••
{sp}
{m}<════════════[{k} •  {p}SPAM SMS TARGET{k} •{m} ]══════════════>
{hi}╔╗ ┬─┐┬ ┬┌┬┐┌─┐┬  ╔═╗┌─┐┌─┐┌┬┐┌┬┐┌─┐┬─┐
{p}╠╩╗├┬┘│ │ │ ├─┤│  ╚═╗├─┘├─┤││││││├┤ ├┬┘
{k}╚═╝┴└─└─┘ ┴ ┴ ┴┴─┘╚═╝┴  ┴ ┴┴ ┴┴ ┴└─┘┴└─
{hi}Creator{p}:{k} Julio.Pangkey
{hi}Youtube{p}:{k} Kz.tutorial
{hi}Github {p}:{k} github.com/Kz.tutorial
{hi}Whastap{p}:{k} https://wa.me/qr/P2Q2UCA4TL64J1
{hi}Facebok{p}:{k} Bengkell Akunn
{m}=====================================================
{u} info {hi}:{p} tidak di salah gunakan yah{k} !!!
""")
print ("\033[36m[\033[33m•\033[36m] \033[32mContoh \033[37m:\033[33m 085785Xxxx")
while True:
	try:
		a=input("\033[36m[\033[33m•\033[36m]\033[32m Nomor Target \033[37m : \033[32m")
		asu=a[0:2]
